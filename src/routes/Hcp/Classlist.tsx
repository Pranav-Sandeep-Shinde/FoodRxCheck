...
const ClassList = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen w-full overflow-hidden">
      <div className="flex flex-col items-center justify-center bg-white-900 p-6 w-full max-w-lg">
        {/* Carousel Container */}
        ...
        <div className="mt-4 flex gap-2">
          {classes.map((_, index) => (
            <button
              ...
              className={`h-2 w-2 rounded-full ${currentIndex === index ? "bg-black" : "bg-gray-400"}`}
            />
          ))}
        </div>
      </div>
